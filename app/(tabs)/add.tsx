    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
        ...
        >
          ...
          <PlatedButton label="Plate It" onPress={handleSave} loading={saving} style={styles.saveBtn} />
        </ScrollView>
      </KeyboardAvoidingView>
...
const styles = StyleSheet.create({
  ...
  shutterButton: {
    ...
    borderWidth: 4, borderColor: Palette.white,
    alignItems: 'center', justifyContent: 'center',
    marginBottom: 20,
  },
  shutterInner: { width: 56, height: 56, borderRadius: 28, backgroundColor: Palette.white },
});
